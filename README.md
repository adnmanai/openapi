# uxg OpenAPI Specification
[![Build Status](https://travis-ci.org/adnmanai/openapi.svg?branch=master)](https://travis-ci.org/adnmanai/openapi)
...
6. If you did everything correct, https://adnmanai.github.io/openapi/ will lead to your new docs
...
- Documentation(ReDoc): https://adnmanai.github.io/openapi/
- SwaggerUI: https://adnmanai.github.io/openapi/swagger-ui/
- Look full spec:
    + JSON https://adnmanai.github.io/openapi/swagger.json
    + YAML https://adnmanai.github.io/openapi/swagger.yaml
- Preview spec version for branch `[branch]`: https://adnmanai.github.io/openapi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://adnmanai.github.io/openapi/ with url from the message: `Server started <url>`
